...
> **Note:** The `countryName` field is optional and for your own reference. The `teamId` is required; you can find it by hovering over the team flag or checking the URL address on team-specific pages in the game.
